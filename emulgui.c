...
void mloop() {
  ...
  do {
    ...
    case 0x0:                            // LOD Rd,Rs1,Rs2
      ...
      } else if (regs[src2] == 0xFFF1) { // If memory belongs to I/O map, for each device
    ...
    case 0x6:                             // SHR Rd,Rs1,Rs2
      ...
      case 2:
        ...
        break;
      case 3:
        regs[dest] = (regs[src1] << n) | (regs[src1] >> (16 - n)); // Rotate right is clumsy in C, combination of left and right shift
        break;
      }
      break;
